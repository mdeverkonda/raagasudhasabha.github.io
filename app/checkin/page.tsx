...
// The Worker proxy serves CORS-friendly JSON, so a plain fetch() works on every
// browser including iOS Safari. (Apps Script's /exec URL alone would 302 to
// googleusercontent.com and trip iOS ITP.)
